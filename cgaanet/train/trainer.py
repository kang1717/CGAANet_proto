...
from cgaanet.train.loss import LossDefinition
...
class Trainer:
    """
    Training routine specialized for this package. Depends on 'cgaanet.train.loss'
    ...
    def args_from_checkpoint(checkpoint: str) -> Tuple[Dict, Dict, Dict]:
        ...
        """
        from cgaanet.util import model_from_checkpoint, pretrained_name_to_path
