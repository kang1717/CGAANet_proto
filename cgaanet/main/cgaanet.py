...
description = f'cgaanet version={__version__}, train model based on the input.yaml'
...
def run(args):
    ...
    from cgaanet.parse_input import read_config_yaml
    from cgaanet.scripts.train import train, train_v2
...
def main():
    ...
    ag.add_argument(
        ...
        '--log',
        default='log.cgaanet',
        help='name of logfile, default is log.cgaanet',
        type=str,
    )
    ag.add_argument(
        '-s',
