...
description = (
    f'cgaanet version={__version__}, cgaanet_inference. '
    + 'Evaluate cgaanet_data/ase readable '
...
def run(args):
    ...
    from cgaanet.scripts.inference import inference
    from cgaanet.util import pretrained_name_to_path
...
def main():
    ...
    ag.add_argument(
        ...
        '--save_graph',
        action='store_true',
        help='Additionally, save preprocessed graph as cgaanet_data'
    )
    ag.add_argument(
        '--kwargs',
